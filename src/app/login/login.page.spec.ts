...
describe('HomePage', () => {
  ...
  it('should navigate to "home" when login button is clicked and form is valid', () => {
    ...
    component.formularioLogin.controls['usuario'].setValue('user'); // Usuario válido
    component.formularioLogin.controls['contraseña'].setValue('password'); // Contraseña válida
